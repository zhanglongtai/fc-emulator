...
const testGame2 = function() {
    ...
    // ]
    const gameCodes = [
        0x20, 0x09 , 0x06 , 0x20 , 0x0c , 0x06 , 0x20 , 0x12 , 0x06 , 0xa2 , 0x00 , 0x60 , 0xe8 , 0xe0 , 0x05 , 0xd0,
        0xfb, 0x60, 0x00,
    ]
...
const testGame3 = function() {
    ...
    window.addEventListener('keydown', (event) => {
        ...
        if (event.code === 'KeyW') {
            cpu.setValue(0xFF, 0x77)
        }
        if (event.code === 'KeyD') {
            cpu.setValue(0xFF, 0x64)
        }
        if (event.code === 'KeyS') {
            cpu.setValue(0xFF, 0x73)
        }
        if (event.code === 'KeyA') {
            cpu.setValue(0xFF, 0x61)
        }
    })
